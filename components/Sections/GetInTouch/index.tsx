  ...
  return (
    ...
    >
      ...
      <Text variant="description">
        Though, I am confident in myself. I do reply to messages as long as my
        ...
        or shoot me an{' '}
        <Link href="ericfoxiam0214@gmail.com" target="_blank" rel="noreferrer">
          email
        </Link>
        .
      </Text>
      ...
      >
        ...
        >
          <Text as="span">
            ...
            Eric Ding <Icon as={RiCopyleftLine} /> 2026
          </Text>
        </Link>
      </Box>
    </Stack>
